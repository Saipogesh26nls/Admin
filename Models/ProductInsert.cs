...
namespace Admin.Models
{
    ...
    {
        public int AddData(string cP_Name, string cP_Disp_Name, string cP_Manufacturer,string cPackage, string cValue, string cP_Part_No, string cP_Description, double cP_Cost, double cP_MRP, double cP_SP) 
        {
            ...
            sql_cmnd.Parameters.AddWithValue("@PPackage", SqlDbType.NChar).Value = cPackage;
            sql_cmnd.Parameters.AddWithValue("@PValue", SqlDbType.NChar).Value = cValue;
            sql_cmnd.Parameters.AddWithValue("@PPartNo", SqlDbType.NVarChar).Value = cP_Part_No;
             ...
             string cmd1 = "update Product_Master set P_Name = UPPER(P_Name), P_Disp_Name = UPPER(P_Disp_Name), P_Region = UPPER(P_Region), P_Part_No = UPPER(P_Part_No), P_Description = UPPER(P_Description), P_Package = UPPER(P_Package), P_Value = UPPER(P_Value)";
